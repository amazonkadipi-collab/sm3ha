...
- [ ] استبدال محتوى `main` في GitHub بنسخة NaghmaHub النهائية بعد التأكيد، مع الاحتفاظ بالفروع القديمة.
- [ ] التحقق من أن `main` يعرض الكود الكامل والواجهة العربية بعد الدفع.
